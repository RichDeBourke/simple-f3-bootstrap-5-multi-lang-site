...
class enPageController extends Controller {
    ...
    protected function loadCommonSettings($f3) {
        $f3->set('LANGUAGE','en');
        $f3->set('langSubdirectory','en');
    }

    public function RenderHome($f3) {
        $this->loadCommonSettings($f3);
        $f3->set('pageTitle','Site Construction');
        $f3->set('pageDescription','Building a frontend / backend setup for a simple, multi-language website using Bootstrap 5 with the Fat-Free PHP framework, but no database.');
    ...
    public function renderDetails1($f3) {
        $this->loadCommonSettings($f3);
        $f3->set('pageTitle','Setting up and modifying Bootstrap 5');
        $f3->set('pageDescription','This site is built with Bootstrap 5, using Sass for the styling and a modified mobile menu setup.');
    ...
    public function renderDetails2($f3) {
        $this->loadCommonSettings($f3);
    ...
    public function renderDetails3($f3) {
        $this->loadCommonSettings($f3);
    ...
    public function renderDetails4($f3) {
        $this->loadCommonSettings($f3);
    ...
    public function renderDetails5($f3) {
        $this->loadCommonSettings($f3);
